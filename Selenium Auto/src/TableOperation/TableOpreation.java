	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < rows.size(); i++) {
			...
			String rowData = rows.get(i)
					.findElement(By.xpath("//*[@id=\"content\"]/table/tbody/tr[" + (i + 1) + "]/td[2]")).getText();

			System.out.println("the value of row data" + rowData);
			if (rowData.contains("Shanghai")) {

				String country = rows.get(i)
						.findElement(By.xpath("//*[@id=\"content\"]/table/tbody/tr[" + (i + 1) + "]/td[1]")).getText();
